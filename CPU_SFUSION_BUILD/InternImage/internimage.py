...
class InternImage(nn.Module):
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            ckpt = _load_checkpoint(self.init_cfg,
                                    logger=logger,
                                    map_location='cpu')
    ...
    def forward(self, x):
        ...
        return seq_out
# pretrained = '/content/drive/MyDrive/GNDetFusion/GNDetFusion/backbones/backbone_checkpoint.pth' 
...
# input_data = torch.randn(6, 3, 601, 400).to(device)

# # Perform inference
# with torch.no_grad():
#     output_features = intern_image_model(input_data)
#     # print(output_features)
#     out3 = output_features[3].cpu().numpy()
#     print(out3.shape)
# # ===============================================================
